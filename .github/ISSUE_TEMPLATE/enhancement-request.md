...
about: Describe something c_chan currently doesn't do that you'd like it to — or does
...
**What doesn't c_chan currently do (or does do, but not in a way you'd like)?**

**What would you like c_chan to do (instead)?**
